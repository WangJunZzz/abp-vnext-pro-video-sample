...
export class BlogsServiceProxy extends ServiceProxyBase {
    private instance: AxiosInstance;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    createBlog(body: CreateBlogInput | undefined , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/blogs/createBlog";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processCreateBlog(_response));
        });
    }

    protected processCreateBlog(response: AxiosResponse): Promise<void> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
     ...
     * @return Success
     */
    pageBlog(body: BlogPagingInput | undefined , cancelToken?: CancelToken | undefined): Promise<BlogPagingOutputPagedResultDto> {
        let url_ = this.baseUrl + "/blogs/pageBlog";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.transformResult(url_, _response, (_response: AxiosResponse) => this.processPageBlog(_response));
        });
    }

    protected processPageBlog(response: AxiosResponse): Promise<BlogPagingOutputPagedResultDto> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200  = _responseText;
            result200 = BlogPagingOutputPagedResultDto.fromJS(resultData200);
            return Promise.resolve<BlogPagingOutputPagedResultDto>(result200);
        ...
        return Promise.resolve<BlogPagingOutputPagedResultDto>(null as any);
    }
}
...
export class BlogPagingInput implements IBlogPagingInput {
    pageIndex!: number;
    pageSize!: number;
    readonly skipCount!: number;
    filter!: string | undefined;

    constructor(data?: IBlogPagingInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): BlogPagingInput {
        data = typeof data === 'object' ? data : {};
        let result = new BlogPagingInput();
        result.init(data);
        return result;
    }
...
export interface IBlogPagingInput {
    pageIndex: number;
    pageSize: number;
    skipCount: number;
    filter: string | undefined;
...
export class BlogPagingOutput implements IBlogPagingOutput {
    id!: string;
    name!: string | undefined;
    signature!: string | undefined;
    github!: string | undefined;

    constructor(data?: IBlogPagingOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): BlogPagingOutput {
        data = typeof data === 'object' ? data : {};
        let result = new BlogPagingOutput();
        result.init(data);
        return result;
    }
...
export interface IBlogPagingOutput {
    id: string;
    name: string | undefined;
    signature: string | undefined;
    github: string | undefined;
...
export class BlogPagingOutputPagedResultDto implements IBlogPagingOutputPagedResultDto {
    items!: BlogPagingOutput[] | undefined;
    totalCount!: number;

    constructor(data?: IBlogPagingOutputPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items!.push(BlogPagingOutput.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): BlogPagingOutputPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new BlogPagingOutputPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IBlogPagingOutputPagedResultDto {
    items: BlogPagingOutput[] | undefined;
    totalCount: number;
}
...
export class CreateBlogInput implements ICreateBlogInput {
    name!: string;
    signature!: string | undefined;
    github!: string | undefined;

    constructor(data?: ICreateBlogInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateBlogInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateBlogInput();
        result.init(data);
        return result;
    }
