...
using MyLion.Erp.EntityFrameworkCore;
...
namespace MyLion.Erp.Migrations
{
    ...
    [Migration("20220828052421_AddBlog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyLion.Erp.Blogs.Aggregates.Blog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("ErpBlog", (string)null);
                });

            modelBuilder.Entity("MyLion.Erp.Blogs.Aggregates.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("MyLion.Erp.Blogs.Aggregates.Post", b =>
                {
                    b.HasOne("MyLion.Erp.Blogs.Aggregates.Blog", null)
                        .WithMany("Posts")
