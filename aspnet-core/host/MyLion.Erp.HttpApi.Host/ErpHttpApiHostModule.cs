...
namespace MyLion.Erp
{
    ...
    public class ErpHttpApiHostModule : AbpModule
    {
        ...
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            app.UseMiniProfiler();
            app.UseRouting();
            app.UseCors(ErpHttpApiHostConst.DefaultCorsPolicyName);
            ...
            {
                options.SwaggerEndpoint("/swagger/Erp/swagger.json", "Erp API");
                ...
                .AddJwtBearer(options =>
                {
                    ...
                    options.Events = new JwtBearerEvents
                    {
                        OnMessageReceived = currentContext =>
                        {
                            ...
                            if (accessToken.IsNullOrWhiteSpace())
                            {
                                accessToken = currentContext.Request.Cookies[ErpHttpApiHostConst.DefaultCookieName];
                            }
        ...
        private static void ConfigureSwaggerServices(ServiceConfigurationContext context)
        {
            context.Services.AddSwaggerGen(
                options =>
                {
                    ...
                    options.SwaggerDoc("Erp",
                        new OpenApiInfo { Title = "MyLionErp API", Version = "v1" });
        ...
        private void ConfigureAuditLog(ServiceConfigurationContext context)
        {
            ...
            (
                options =>
                {
                    ...
                    options.ApplicationName = "MyLion.Erp";
                }
            );
